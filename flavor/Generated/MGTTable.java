...
public class MGTTable {
    ...
    public int get(IBitstream _F_bs) throws IOException {
        int _F_ret = 0;
        MapResult _F_mr;
        table_type = _F_bs.getbits(16);
        reserved1 = _F_bs.getbits(3);
        if (reserved1 != 7) {
            Util.flerror("Const value mismatch for 'reserved1'");
            _F_ret++;
        }
        table_type_PID = _F_bs.getbits(13);
        reserved2 = _F_bs.getbits(3);
        if (reserved2 != 7) {
            Util.flerror("Const value mismatch for 'reserved2'");
            _F_ret++;
        }
        table_type_version_number = _F_bs.getbits(5);
        number_bytes = _F_bs.getbits(32);
        reserved3 = _F_bs.getbits(4);
        if (reserved3 != 15) {
            Util.flerror("Const value mismatch for 'reserved3'");
            _F_ret++;
        }
        table_type_descriptors_length = _F_bs.getbits(12);
