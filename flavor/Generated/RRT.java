...
public class RRT {
    ...
    int rating_region_name_length;
    MultiString rating_region_name_text;
    int dimensions_defined;
    int ndim;
    ...
    public int get(IBitstream _F_bs) throws IOException {
        ...
        MapResult _F_mr;
        int _F_parse = 0;
        Util.trace(_F_bs.getpos(), 0, (int)0, "begin RRT");
        _F_parse = 8;
        ...
        _F_parse = 8;
        rating_region = _F_bs.getbits(_F_parse);
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)rating_region, "rating_region" +  " (" + rating_region + ")");
        _F_parse = 2;
        ...
        _F_parse = 8;
        rating_region_name_length = _F_bs.getbits(_F_parse);
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)rating_region_name_length, "rating_region_name_length" +  " (" + rating_region_name_length + ")");
        Util.trace(_F_bs.getpos(), 0, (int)0, "processing MultiString rating_region_name_text");
        rating_region_name_text = new MultiString();
        _F_ret += rating_region_name_text.get(_F_bs);
        _F_parse = 8;
        dimensions_defined = _F_bs.getbits(_F_parse);
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)dimensions_defined, "dimensions_defined" +  " (" + dimensions_defined + ")");
        for (ndim=0; ndim<dimensions_defined; ndim++) {
            Util.trace(_F_bs.getpos(), 0, (int)0, "processing RRTDimension dimension");
            dimension = new RRTDimension();
            _F_ret += dimension.get(_F_bs);
            if (1==0) break;
        }
        _F_parse = 6;
        ...
        Util.trace(_F_bs.getpos(), 0, (int)0, "end RRT");
        return _F_ret;
    }
    ...
    public int put(IBitstream _F_bs) throws IOException {
        ...
        _F_bs.putbits(rating_region_name_length, 8);
        _F_ret += rating_region_name_text.put(_F_bs);
        _F_bs.putbits(dimensions_defined, 8);
        for (ndim=0; ndim<dimensions_defined; ndim++) {
            _F_ret += dimension.put(_F_bs);
            if (1==0) break;
        }
        _F_parse = 6;
        reserved4 = 63;
    ...
    public int putxml(IBitstream _F_bs, boolean bAttr) throws IOException {
        ...
        rating_region = _F_bs.getbits(_F_parse);
        if (bAttr) {
            XML.WriteXmlElement("<rating_region type=\"flUInt\" bitLen=\"" + _F_parse + "\">" + rating_region + "</rating_region>");
        }
        else {
            XML.WriteXmlElement("<rating_region bitLen=\"" + _F_parse + "\">" + rating_region + "</rating_region>");
        }
        _F_parse = 2;
        reserved3 = _F_bs.getbits(_F_parse);
        if (reserved3 != 3) {
        ...
        rating_region_name_length = _F_bs.getbits(_F_parse);
        if (bAttr) {
            XML.WriteXmlElement("<rating_region_name_length type=\"flUInt\" bitLen=\"" + _F_parse + "\">" + rating_region_name_length + "</rating_region_name_length>");
        }
        else {
            XML.WriteXmlElement("<rating_region_name_length bitLen=\"" + _F_parse + "\">" + rating_region_name_length + "</rating_region_name_length>");
        }
        Util.trace(_F_bs.getpos(), 0, (int)0, "processing MultiString rating_region_name_text");
        rating_region_name_text = new MultiString();
        XML.IntoAClass("rating_region_name_text", 0);
        _F_ret += rating_region_name_text.putxml(_F_bs, bAttr);
        XML.OutOfClass("</rating_region_name_text>");
        _F_parse = 8;
        dimensions_defined = _F_bs.getbits(_F_parse);
        if (bAttr) {
            XML.WriteXmlElement("<dimensions_defined type=\"flUInt\" bitLen=\"" + _F_parse + "\">" + dimensions_defined + "</dimensions_defined>");
        }
        else {
            XML.WriteXmlElement("<dimensions_defined bitLen=\"" + _F_parse + "\">" + dimensions_defined + "</dimensions_defined>");
        }
        for (ndim=0; ndim<dimensions_defined; ndim++) {
            Util.trace(_F_bs.getpos(), 0, (int)0, "processing RRTDimension dimension");
            dimension = new RRTDimension();
            XML.IntoAClass("dimension", 0);
            _F_ret += dimension.putxml(_F_bs, bAttr);
