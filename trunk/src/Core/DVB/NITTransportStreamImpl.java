...
public class NITTransportStreamImpl implements NITTransportStream {
	...
	/* (non-Javadoc)
	 * @see API.DVB.NITTransportStream#getOrgNetworkId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see API.DVB.NITTransportStream#getTransportStreamId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see API.DVB.NITTransportStream#setOrgNetworkId(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see API.DVB.NITTransportStream#setTransportStreamId(int)
	 */
	@Override
	...
	public String toXMLString(int base_space) {
		...
		str += (MyUTIL.whiteSpaceStr(base_space)+"<NITTransportStream>\n");
