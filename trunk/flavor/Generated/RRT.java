...
public class RRT {
    ...
    public int get(IBitstream _F_bs) throws IOException {
        ...
        reserved2 = _F_bs.getbits(8);
        if (reserved2 != 255) {
            Util.flerror("Const value mismatch for 'reserved2'");
            _F_ret++;
        }
        rating_region = _F_bs.getbits(8);
        reserved3 = _F_bs.getbits(2);
        if (reserved3 != 3) {
